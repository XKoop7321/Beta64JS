...
var inputBase = require('os').homedir() + '/tpp/levels/' + level + '/areas/' +areaNum+ '/geo.inc.c' // directory of each model file
var AreaDirBase = require('os').homedir() + '/tpp/levels/' + level + '/areas/' +areaNum + '/'  // used for DL checks
...
while (snum <= num) {
	var input = require('os').homedir() + '/tpp/levels/' + level + '/areas/' +areaNum+ '/' + snum + '/geo.inc.c' 
	var cAreaDir = require('os').homedir() + '/tpp/levels/' + level + '/areas/' +areaNum+ '/' + snum + '/' 
